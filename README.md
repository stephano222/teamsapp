...
チーム開発ができる募集掲示板（事前に役割を決めることで、参加者がいろんな役割のチーム開発を経験でき、失敗を繰り返す場所として機能し、アプリの完成だけではなく、チーム開発をする上での経験を積み、失敗をさせる開発ができる場所、失敗の経験を大量に積むためのチーム開発が募集できる掲示板）
...
　時間の一致や同じ人としかできない可能性がある為、繰り返し開発が経験できる場所と共通認識の目的や決まりがある場所で募集するのとでは、また違いがあると思う）　必要事項や役割などが曖昧な為、その役　割しか経験できない可能性があるため、このアプリでは事前に何の役割でチーム開発をするのか？を人狼ゲームのようにこちらが事前に決めるために（ランダム機能もあり）、ゲーム感覚で参加できるようになる　のがこのアプリの最終目標。
- 
